...
def main(tta_iters=10):
    ...
    for fold_number in range(n_folds):
        ...
        ckpt_fpath = (
            models_path
            / f"model_name=efficientnet_sz=384_fold={fold_number}.ckpt"
        )
    ...
    oof_preds.to_csv(
        data_path / "oof_preds_efficientnet_tta_384.csv", index=False
    )
    ...
    preds.to_csv(
        submissions_path / "l1_efficientnet_tta_384_submission.csv",
        index=False,
    )
